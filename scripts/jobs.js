const userID = "cm4czfev60001uohonnkxv70z";
...
`,
  },
  {
    ...
    workMode: "On-Site",
    salary: 300000,
    skills: ["javascript", "react.js", "typescript", "sass"],
    openings: 4,
    applications: 52,
    description: `
**About Vercel:** 
...
`,
  },
  {
    ...
    workMode: "On-Site",
    salary: 1600000,
    skills: ["Docker", "Kubernates", "AWS", "Go", "Python"],
    openings: 1,
    applications: 9,
    description: `
**About Microsoft:**
...
`,
  ...
  },
  {
    ...
    openings: 1,
    applications: 8,
    description: "Analyze data trends and create predictive models.",
  },
  {
    postedById: userID,
    companyLogo: "",
    companyName: "SecureSys",
    ...
    workMode: "On-site",
    salary: 110000,
    skills: ["Network Security", "Firewalls", "Incident Response"],
    openings: 2,
    applications: 12,
    description: "Monitor and secure enterprise IT systems.",
  },
  {
    postedById: userID,
    companyLogo: "",
  ...
  },
  {
    ...
    openings: 4,
    applications: 20,
    description: "Develop and maintain dynamic websites.",
  },
  {
    postedById: userID,
    companyLogo: "",
    ...
    workMode: "Hybrid",
    salary: 135000,
    skills: ["Python", "PyTorch", "Deep Learning", "Data Engineering"],
    openings: 2,
    applications: 18,
    description: "Create and optimize machine learning models.",
  },
  {
    postedById: userID,
    companyLogo: "",
    companyName: "DevOps Central",
    experience: "4-6 years",
    ...
    workMode: "Remote",
    salary: 120000,
    skills: ["Jenkins", "CI/CD", "Kubernetes", "AWS"],
    openings: 3,
    applications: 10,
    description: "Automate and improve software deployment processes.",
  },
  {
    postedById: userID,
    companyLogo: "",
    ...
    openings: 2,
    applications: 9,
    description: "Develop and maintain backend APIs and services.",
  },
  {
    postedById: userID,
    companyLogo: "",
    ...
    workMode: "On-site",
    salary: 70000,
    skills: ["Troubleshooting", "Networking", "Windows OS"],
    openings: 5,
    applications: 30,
